...
public class projParser extends Parser {
	...
	public static final int
		...
		RULE_obj = 25, RULE_article = 26, RULE_noun = 27, RULE_atom = 28, RULE_postfix = 29, 
		RULE_printArgs = 30, RULE_param = 31;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"compExp", "addExp", "mulExp", "unaryExp", "verb", "obj", "article", 
			"noun", "atom", "postfix", "printArgs", "param"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'<='", "'>='", "'+'", "'-'", "'*'", "'/'", "'not'", "'show'", "'tell'", 
			"'me'", "'the'", "'an'", "'a'", "'--'", "'++'", "'+='", "'-='", null, 
			"'def'", "'if'", "'elif'", "'else'", "':'", "'break'", "'while'", "'for'", 
			"'in'", "'range'", "'return'", "'print'", "'True'", "'False'", "'None'", 
			null, null, "'='"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 299952731717632L) != 0) );
			setState(70);
			match(EOF);
			}
		}
	...
	public final PrintArgsContext printArgs() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_printArgs);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
